        ...
        <div className="homepage">
            <header className="homepage__hero">
                ...
                <div className="homepage__hero-content align">
                    <div className="homepage__slogan-container">
                        <h1 className="text--white anton-heading" >Unlock your possibilities.</h1>
                    </div>
            ...
            <main className="homepage__main">
                <div className="homepage__title">
                    <h3 className="title-color anton-heading">Explore Your Intrests</h3>
                </div>
                ...
                <section className="align">
                    <h3 className="title-color anton-heading" style={{textAlign: "center", paddingTop: "7.5%"}}>Invest in Your Future & <br/> Start Achieving Your Goals Today!</h3>
                    <Plans />
                </section>
            </main>
        </div>
