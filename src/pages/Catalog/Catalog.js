    ...
    return (
        <div className="catalog">
            <div className="catalog__trending align">
                <div className="trending__title"><h2 className="title-color anton-heading">Trending Courses</h2></div>
            ...
            <div className="catalog__courses align">
                <div className="courses__title"><h2 className="title-color anton-heading">All Courses</h2></div>
